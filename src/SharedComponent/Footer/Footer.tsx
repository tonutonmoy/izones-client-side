        ...
        <Container>
          <div className="-mx-4 flex flex-wrap justify-between">
            ...
            <Link href='/'>
              ...
              <Link   href="https://wa.me/16476749796"  className="inline-flex items-center justify-center h-8 w-8 border border-gray-100 rounded-full mr-1 hover:text-green-400 hover:border-green-400">
              ...
              <a href="https://www.instagram.com/khurshids_/?hl=en" className="inline-flex items-center justify-center h-8 w-8 border border-gray-100 rounded-full mr-1 hover:text-red-00 hover:border-red-500">
                <svg className="w-4 h-4 fill-current" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 448 512">
