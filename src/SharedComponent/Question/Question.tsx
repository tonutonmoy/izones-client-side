...
const questionsData = [
  { question: "What is iZones?", answer: "iZones is a colour imaginary umbrella to shed you with service in your day-to-day lives " },
  { question: "What is our goal?", answer: "Let's Connect worldwide and help each other shine" },
  { question: "What services do we offer?", answer: `1.
...
2. We offer Technical Support for any of your Apple devices over the phone. We are also specialized in resolving Apple Account issues` },
  { question: "Why trust us?", answer: `Because we say NO!

We are committed to provide you with what you deserve. We only offer services that we have skilled professionals for. If we cannot get your job done, we say NO` },
  { question: "What makes us special?", answer: `15 minutes make us special
Regardless of wanting to book IELTS courses with us, or making online appointments with us to get your Apple Account fixed, you can always schedule a 15 minutes online consultation with our experts and it’s absolutely FREE! ` },
  { question: "How to get our services?", answer: `Please send us a message on WhatsApp and we will send you a Google Form to fill out. Once we receive the forms, our services will start knocking on your doors` },
];
