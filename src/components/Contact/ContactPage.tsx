  ...
  return (
    <section className="bg-gray-50 "id="contact">
      <div className="mx-auto max-w-7xl px-4 py-16 sm:px-6 lg:px-8 lg:py-20">
        ...
        <div className="px-4 my-4 w-full xl:w-1/5 bg-gray-800 p-3  rounded-full ">
         ...
         <Link href="#" className="inline-flex items-center justify-center h-8 w-8 border  rounded-full mr-1 text-green-400 border-green-400">
         ...
         <a href="#" className="inline-flex items-center justify-center h-8 w-8 border  rounded-full mr-1 text-red-500 border-red-500">
           <svg className="w-4 h-4 fill-current" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 448 512">
